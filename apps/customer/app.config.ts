...
export default (): ExpoConfig => {
  ...
  return ({
  name: 'Pickup Customer', slug: 'customer-pickup', version: '1.0.0', orientation: 'portrait', userInterfaceStyle: 'dark',
  scheme: 'customer-pickup', newArchEnabled: true, runtimeVersion: {policy:'appVersion'},
  android: { package: 'com.pickup.customer', versionCode: 1, permissions: ['ACCESS_FINE_LOCATION','ACCESS_COARSE_LOCATION','RECORD_AUDIO','POST_NOTIFICATIONS'] },
  ios: { bundleIdentifier: 'com.pickup.customer', supportsTablet: true, infoPlist: {
